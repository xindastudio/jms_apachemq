 ...
 * 
 */
public class IMGroup implements MessageListener, Runnable {
	 ...
	 * @param transacted
	 */
	public IMGroup(String user, String password, String url, String sendTo,
			boolean transacted) {
		this.user = user;
	...
	private boolean receive() {
		try {
			Destination destination = session.createTopic(sendTo);
